object_tangible_ship_components_reactor_shared_rct_krayt_neverdie = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/ship/components/reactor/shared_rct_krayt_neverdie.iff"
}

ObjectTemplates:addClientTemplate(object_tangible_ship_components_reactor_shared_rct_krayt_neverdie, "object/tangible/ship/components/reactor/shared_rct_krayt_neverdie.iff")
