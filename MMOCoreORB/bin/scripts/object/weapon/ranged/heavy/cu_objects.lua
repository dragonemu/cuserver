...
object_weapon_ranged_heavy_shared_heavy_acid_beam_static = SharedWeaponObjectTemplate:new {
	clientTemplateFileName = "object/weapon/ranged/heavy/shared_heavy_acid_beam_static.iff"
}

ObjectTemplates:addClientTemplate(object_weapon_ranged_heavy_shared_heavy_acid_beam_static, "object/weapon/ranged/heavy/shared_heavy_acid_beam_static.iff")


object_weapon_ranged_heavy_shared_heavy_avatar_acid_beam = SharedWeaponObjectTemplate:new {
	clientTemplateFileName = "object/weapon/ranged/heavy/shared_heavy_avatar_acid_beam.iff"
}

ObjectTemplates:addClientTemplate(object_weapon_ranged_heavy_shared_heavy_avatar_acid_beam, "object/weapon/ranged/heavy/shared_heavy_avatar_acid_beam.iff")


object_weapon_ranged_heavy_shared_heavy_lightning_beam_static = SharedWeaponObjectTemplate:new {
	clientTemplateFileName = "object/weapon/ranged/heavy/shared_heavy_lightning_beam_static.iff"
}

ObjectTemplates:addClientTemplate(object_weapon_ranged_heavy_shared_heavy_lightning_beam_static, "object/weapon/ranged/heavy/shared_heavy_lightning_beam_static.iff")


object_weapon_ranged_heavy_shared_heavy_rocket_launcher_generic = SharedWeaponObjectTemplate:new {
	clientTemplateFileName = "object/weapon/ranged/heavy/shared_heavy_rocket_launcher_generic.iff"
}
